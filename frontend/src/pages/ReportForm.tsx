    ...
    <div className="bg-stone-900">
      <div className="mx-auto max-w-xl px-4 py-10">
        ...
        <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
          <FormField label="Photo" htmlFor="image" error={errors.image} labelClassName="text-stone-200">
            <input
              id="image"
              type="file"
              accept="image/*"
              onChange={handleImageChange}
              className="block w-full text-sm text-stone-300 file:mr-3 file:rounded-md file:border-0 file:bg-amber-600 file:px-4 file:py-2 file:text-sm file:font-medium file:text-white hover:file:bg-amber-700"
            />
            {imagePreview && (
              <img
                src={imagePreview}
                alt="Selected pet"
                className="mt-3 h-40 w-40 rounded-md border border-stone-700 object-cover"
              />
            )}
          </FormField>

          <FormField label="Species" htmlFor="species" error={errors.species} labelClassName="text-stone-200">
            <select
              id="species"
              value={form.species}
          ...
          <FormField label="Breed (optional)" htmlFor="breed" labelClassName="text-stone-200">
            <input
              id="breed"
              type="text"
              value={form.breed}
          ...
          <FormField label="Color" htmlFor="color" labelClassName="text-stone-200">
            <input
              id="color"
              type="text"
              value={form.color}
          ...
          <FormField label="Description (optional)" htmlFor="description" labelClassName="text-stone-200">
            <textarea
              id="description"
              rows={4}
          ...
          <FormField label="Contact info" htmlFor="contact_info" error={errors.contact_info} labelClassName="text-stone-200">
            <input
              id="contact_info"
              type="text"
